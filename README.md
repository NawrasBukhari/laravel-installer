# Laravel Web Installer | A Web Installer [Package](https://packagist.org/packages/nawrasbukhari/laravel-installer)
...
* [Laravel 7.*|8.*|9.*|10.*](https://laravel.com/docs/installation)
...
```bash
    composer require nawrasbukhari/laravel-installer
```
...
```php
	'providers' => [
	    NawrasBukhari\LaravelInstaller\Providers\LaravelInstallerServiceProvider::class,
	];
```
